...
namespace EventStore.Core.Util
{
    public static class Opts
    {
        ...
        public const string TFChunkInitialReaderCountDescr = "The initial number of readers to start when opening a TFChunk";
        public const int TFChunkInitialReaderCountDefault  = 5;
