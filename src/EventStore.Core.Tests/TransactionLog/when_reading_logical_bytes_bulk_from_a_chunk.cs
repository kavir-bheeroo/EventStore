...
namespace EventStore.Core.Tests.TransactionLog
{
    ...
    public class when_reading_logical_bytes_bulk_from_a_chunk : SpecificationWithDirectory
    {
        ...
        {
            var chunk = TFChunkDbHelper.CreateNewChunk(GetFilePathFor("file1"), false, 2000);
        ...
        {
            var chunk = TFChunkDbHelper.CreateNewChunk(GetFilePathFor("file1"), false, 300);
        ...
        {
            var chunk = TFChunkDbHelper.CreateNewChunk(GetFilePathFor("afile"), true, 200);
        ...
        {
            var chunk = TFChunkDbHelper.CreateNewChunk(GetFilePathFor("file1"), false, 3000);
